  ...
  <div class="row">
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            A new restaurant in our franchise opened this weekend at Brussels.
        ...
        <div class="card">
          ...
          <div class="card-body">
            To celebrate the opening of our new restaurant in Brussels, a brand new
            ...
            naturally evoke the subtle fragrance of the orient.
          </div>
        </div>
        <div class="card">
          <div class="card-header bg-wood">
          ...
          <div class="card-body">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam vehicula sem ac
